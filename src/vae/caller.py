"""Simulated caller: drives a LiveKit voice session from a persona script.
...
Loop shape follows the portfolio's agentic-run-lifecycle pattern: a hard
turn cap (the shorter of the script length and the persona's own
